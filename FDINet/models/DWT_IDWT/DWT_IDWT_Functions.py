...
class DWTFunction_2D(Function):
    ...
    def backward(ctx, grad_LL, grad_LH, grad_HL, grad_HH):
        ...
        grad_LL = grad_LL.to(matrix_Low_0.dtype)
        grad_LH = grad_LH.to(matrix_Low_0.dtype)
        grad_HL = grad_HL.to(matrix_Low_0.dtype)
        grad_HH = grad_HH.to(matrix_Low_0.dtype)
...
class IDWTFunction_2D(Function):
    ...
    def backward(ctx, grad_output):
        matrix_Low_0, matrix_Low_1, matrix_High_0, matrix_High_1 = ctx.saved_variables
        grad_output = grad_output.to(matrix_Low_0.dtype)
